...
///media/geoserver/transferencias/registro/fotos 
        ...
        foreach ($files as $file) {
            ...
            if( is_file($file->getRealPath()) ){
                ...
                $lista = DB::connection('BDGeralVinhedoImagem')->select("SELECT codImagem ,   CadTerPrefNum as inscricao ,  ImagemNomeAnterior , ImagemNome ,   CAST(CAST(LocalArquivo AS VARCHAR(8000)) AS TEXT)  as subiu
                                                                        FROM dbo.imagem 
